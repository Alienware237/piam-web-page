...
class __TwigTemplate_a3722902c20a919cc2b476b344290f54 extends Template
{
    private $source;
    private $macros = [];
...
{% endif %}
{% endblock %}
", "@email/zurb_2/notification/body.txt.twig", "/opt/project/vendor/symfony/twig-bridge/Resources/views/Email/zurb_2/notification/body.txt.twig");
    }
}
