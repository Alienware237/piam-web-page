...
class __TwigTemplate_70c2efa803d9c3676891642547261b6d extends Template
{
    private $source;
    private $macros = [];
...
{% for css_asset in assets %}
    ...
    {% endif %}
{% endfor %}
", "@EasyAdmin/includes/_css_assets.html.twig", "/opt/project/vendor/easycorp/easyadmin-bundle/src/Resources/views/includes/_css_assets.html.twig");
    }
}
