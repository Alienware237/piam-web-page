...
class __TwigTemplate_791139e5ba636b2485bd5618b8e8b391 extends Template
{
    private $source;
    private $macros = [];
...
Symfony Twig Bridge to ensure that all applications building backends with EasyAdmin
use the same version of the templates, even those still using Symfony 4.4.
", "@EasyAdmin/symfony-form-themes/README.txt", "/opt/project/vendor/easycorp/easyadmin-bundle/src/Resources/views/symfony-form-themes/README.txt");
    }
}
