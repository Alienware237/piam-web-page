...
class __TwigTemplate_c3c204feea57d677fac569ddd096e73d extends Template
{
    private $source;
    private $macros = [];
...
{%- macro render_table_runs(runs, mode) -%}
    ...
    {%- endif -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/panel.html.twig", "/opt/project/vendor/jms/serializer-bundle/Resources/views/Collector/panel.html.twig");
    }
}
