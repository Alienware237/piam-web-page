 ...
 */
class okpt_my_web_page_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'okpt\\my\\web\\page\\Controller\\IndexController' => 'getIndexControllerService',
        ...
        $this->aliases = [
            ...
            'okpt\\my\\web\\page\\Kernel' => 'kernel',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d = new \Doctrine\Bundle\DoctrineBundle\Middleware\DebugMiddleware(new \Doctrine\Bundle\DoctrineBundle\Middleware\BacktraceDebugDataHolder([]), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('i6HePOPexf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ea-kGB-Rup', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1cxL1UZ8Mv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UvhE-3LC51', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('G2KYBB2xuO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PxprHql5tE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HLbdgWJDBc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        ...
        ]), [0 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 1 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 2 => 'Knp\\DoctrineBehaviors\\EventSubscriber\\BlameableEventSubscriber', 3 => 'Knp\\DoctrineBehaviors\\EventSubscriber\\LoggableEventSubscriber', 4 => 'Knp\\DoctrineBehaviors\\EventSubscriber\\SluggableEventSubscriber', 5 => 'Knp\\DoctrineBehaviors\\EventSubscriber\\SoftDeletableEventSubscriber', 6 => 'Knp\\DoctrineBehaviors\\EventSubscriber\\TimestampableEventSubscriber', 7 => 'Knp\\DoctrineBehaviors\\EventSubscriber\\TranslatableEventSubscriber', 8 => 'Knp\\DoctrineBehaviors\\EventSubscriber\\TreeEventSubscriber', 9 => 'Knp\\DoctrineBehaviors\\EventSubscriber\\UuidableEventSubscriber', 10 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]);
    }
    ...
    protected function getSerializerService()
    {
        ...
        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($e), 1 => new \ApiPlatform\RamseyUuid\Serializer\UuidDenormalizer(), 2 => $h, 3 => $k, 4 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($l, [], $m), 5 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $m), 6 => $k, 7 => $h, 8 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($i, $b, $c, $n, NULL, $l, NULL, $m), 9 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($i, $o, $l), 10 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($l, true), 11 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true), 12 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 13 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 14 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($i, $b, $c, $o, $n, $p, $e, $m, $q, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $d), 15 => new \ApiPlatform\Serializer\ItemNormalizer($b, $c, $o, $n, $e, $m, $q, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
    ...
    private $loadedDynamicParameters = [
        ...
        'DATABASE_URL' => false,
        'MEMCACHED_URL' => false,
        'IMPORTER_CACHE_PATH' => false,
        'GUEST_USER_ID' => false,
        'SF_MR_CLIENTID' => false,
        'SF_MR_COMPANYID' => false,
        'SF_MR_USERNAME' => false,
        'SF_MR_PASSWORD' => false,
        'SF_MR_API_URL' => false,
        'SF_MR_API_VERSION' => false,
        'SF_MR_APPLICATIONURL_EXTERNAL_PREFIX' => false,
        'SF_MR_APPLICATIONURL_INTERNAL_PREFIX' => false,
        'SF_MR_APPLICATIONURL_FRIEND_PREFIX' => false,
        'SF_MR_AUTHENTICATION_URL' => false,
        'JB_MR_IMPORTER_URL' => false,
        'SF_MR_PREFIX' => false,
        'kernel.secret' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'CORS_ALLOW_ORIGIN': $value = $this->getEnv('CORS_ALLOW_ORIGIN'); break;
            case 'DATABASE_URL': $value = $this->getEnv('DATABASE_URL'); break;
            case 'MEMCACHED_URL': $value = $this->getEnv('MEMCACHED_URL'); break;
            case 'IMPORTER_CACHE_PATH': $value = ($this->targetDir.''.'/../'); break;
            case 'GUEST_USER_ID': $value = $this->getEnv('GUEST_USER_ID'); break;
            case 'SF_MR_CLIENTID': $value = $this->getEnv('SF_MR_CLIENTID'); break;
            case 'SF_MR_COMPANYID': $value = $this->getEnv('SF_MR_COMPANYID'); break;
            case 'SF_MR_USERNAME': $value = $this->getEnv('SF_MR_USERNAME'); break;
            case 'SF_MR_PASSWORD': $value = $this->getEnv('SF_MR_PASSWORD'); break;
            case 'SF_MR_API_URL': $value = $this->getEnv('SF_MR_API_URL'); break;
            case 'SF_MR_API_VERSION': $value = $this->getEnv('SF_MR_API_VERSION'); break;
            case 'SF_MR_APPLICATIONURL_EXTERNAL_PREFIX': $value = $this->getEnv('SF_MR_APPLICATIONURL_EXTERNAL_PREFIX'); break;
            case 'SF_MR_APPLICATIONURL_INTERNAL_PREFIX': $value = $this->getEnv('SF_MR_APPLICATIONURL_INTERNAL_PREFIX'); break;
            case 'SF_MR_APPLICATIONURL_FRIEND_PREFIX': $value = $this->getEnv('SF_MR_APPLICATIONURL_FRIEND_PREFIX'); break;
            case 'SF_MR_AUTHENTICATION_URL': $value = $this->getEnv('SF_MR_AUTHENTICATION_URL'); break;
            case 'JB_MR_IMPORTER_URL': $value = $this->getEnv('JB_MR_IMPORTER_URL'); break;
            case 'SF_MR_PREFIX': $value = $this->getEnv('SF_MR_PREFIX'); break;
            case 'kernel.secret': $value = $this->getEnv('APP_SECRET'); break;
            case 'debug.container.dump': $value = ($this->targetDir.''.'/okpt_my_web_page_KernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'okpt_my_web_page_KernelDevDebugContainer',
