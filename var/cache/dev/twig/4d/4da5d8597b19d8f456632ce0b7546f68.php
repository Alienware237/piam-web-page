...
class __TwigTemplate_6651b09161824cc62c867ddd63f003a6 extends Template
{
    private $source;
    private $macros = [];
...
{% for js_asset in assets %}
    ...
    {% endif %}
{% endfor %}
", "@EasyAdmin/includes/_js_assets.html.twig", "/opt/project/vendor/easycorp/easyadmin-bundle/src/Resources/views/includes/_js_assets.html.twig");
    }
}
