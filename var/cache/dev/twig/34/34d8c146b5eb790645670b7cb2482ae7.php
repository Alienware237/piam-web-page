...
class __TwigTemplate_9a1b38b256a7d11de60e80affdeba10d extends Template
{
    private $source;
    private $macros = [];
...
{%- macro render_table_triggered_handlers(handlers) -%}
    ...
    {%- endfor -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/handlers.html.twig", "/opt/project/vendor/jms/serializer-bundle/Resources/views/Collector/handlers.html.twig");
    }
}
